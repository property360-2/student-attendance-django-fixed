...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-m+t#x0vx!p(8_v=-(0-i+q-!m#y#v*!$5j@!h#t#m#v#k')
...
# Using CompressedManifestStaticFilesStorage to handle caching and compression
if not DEBUG:
